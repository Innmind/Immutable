...
final class Lazy implements Implementation
{
    ...
    public function drop(int $size): Implementation
    {
        ...
        return new self(
            $this->type,
            function() use ($values, $size): \Generator {
                $dropped = 0;
    ...
    public function filter(callable $predicate): Implementation
    {
        ...
        return new self(
            $this->type,
            function() use($values, $predicate): \Generator {
                /** @var T $value */
                foreach ($values() as $value) {
    ...
    public function map(callable $function): Implementation
    {
        ...
        return new self(
            $this->type,
            function() use ($values, $function, $validate): \Generator {
                /** @var T $value */
                foreach ($values() as $value) {
                    /** @psalm-suppress InvalidArgument */
    ...
    public function pad(int $size, $element): Implementation
    {
        ...
        return new self(
            $this->type,
            function() use ($values, $size, $element): \Generator {
                /** @var T $value */
                foreach ($values() as $value) {
                    yield $value;
                    --$size;
    ...
    public function slice(int $from, int $until): Implementation
    {
        ...
        return new self(
            $this->type,
            function() use ($values, $from, $until): \Generator {
                $index = 0;
                /** @var T $value */
                foreach ($values() as $value) {
    ...
    public function append(Implementation $sequence): Implementation
    {
        ...
        return new self(
            $this->type,
            function() use ($values, $sequence): \Generator {
                /** @var T $value */
                foreach ($values() as $value) {
                    yield $value;
                }
    ...
    public function __invoke($element): Implementation
    {
        ...
        return new self(
            $this->type,
            function() use ($values, $element): \Generator {
                /** @var T $value */
                foreach ($values() as $value) {
                    yield $value;
                }
    ...
    public function sort(callable $function): Implementation
    {
        ...
        return new self(
            $this->type,
            function() use ($values, $function): \Generator {
    ...
    public function toSequenceOf(string $type, callable $mapper = null): Sequence
    {
        ...
        return Sequence::lazy(
            $type,
            function() use ($values, $mapper): \Generator {
                /** @var T $value */
                foreach ($values() as $value) {
                    /** @var ST $newValue */
